...
<head>
    ...
    <title>Ghost Nova - Shop<%= ownerId %>'s shop</title>
    <style>
        body {
            font-family: Ubuntu;
        }
    ...
    <script>
        <%
            ...
            products = dao.queryByUserId(ownerId);
...
<div id="shop-container" class="shop-container">
    ...
    <div class="media">
        ...
        <div class="media-body" style="position: relative; left: 5px">
            ...
            <span>评分: <span style="color: gold">
                    ...
                    <span>交易次数: <%= products.get(i).getTradingTimes() %></span>
                </span>
        </div>
        <% } %>
    </div>
